import { Play, Shield, Award, Clock, Zap, GraduationCap, ArrowRight } from "lucide-react";
import { useState, useRef, useEffect } from "react";

export const EnvironmentTourSection = () => {
  ...
  return (
    <section className="py-8 md:py-12 bg-slate-900 relative overflow-hidden">
      ...
      <div ref={environmentRef} className="container mx-auto px-4 relative z-10">
