      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <img
            ...
            className="w-20 mb-6 brightness-0 invert opacity-70"
          />

          {/* Social Links */}
          <div className="flex gap-4 mb-6">
            <a
              href="https://www.instagram.com/informatica_prof.elisa/"
              target="_blank"
            ...
            <a
              href="https://api.whatsapp.com/send?phone=5545988287082"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="text-slate-500 text-sm space-y-1">
            <p>Informática na Prática</p>
            <p>CNPJ: 32.625.540/0001-96</p>
