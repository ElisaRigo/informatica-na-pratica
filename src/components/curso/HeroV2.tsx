  ...
  return (
    <section className="relative min-h-screen bg-slate-900 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-4 md:py-8 relative z-10">
        ...
        <div ref={freeClassRef} className="max-w-5xl mx-auto mb-6">
          <div className="text-center mb-4">
            {/* Faixa de destaque */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 text-white px-5 py-2.5 rounded-full text-sm md:text-base font-bold mb-3 border border-primary/40 shadow-lg">
              <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-primary" />
              ✨ Conheça minha forma de ensinar
            </div>
