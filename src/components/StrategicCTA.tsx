    ...
    <div className="py-6 md:py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-primary/10 to-accent/10 border-2 border-primary/30 rounded-3xl p-8">
          ...
          <Button 
            size="lg" 
            className="font-extrabold px-4 md:px-10 py-6 md:py-7 rounded-2xl text-xs md:text-lg hover:scale-105 transition-transform group w-full flex items-center justify-center"
            onClick={() => (window as any).openCheckout?.()}
          >
            <span className="truncate">💪 Quero essa transformação</span>
