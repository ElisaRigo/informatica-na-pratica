...
export const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-panel via-background to-background py-2 md:py-12 lg:py-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-5xl mx-auto animate-fade-in">
          {/* Social Proof Banner */}
          <div className="inline-flex flex-wrap items-center justify-center gap-2 md:gap-4 bg-card/60 backdrop-blur-sm border border-success/20 px-3 md:px-6 py-1 md:py-3 rounded-full mb-2 md:mb-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight mb-2 md:mb-4">
          ...
          <div className="bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 border-2 border-primary/40 rounded-xl md:rounded-2xl px-4 md:px-6 py-1.5 md:py-4 mb-2 md:mb-6 max-w-3xl mx-auto">
          ...
          <div className="mb-2 md:mb-6">
            ...
            <p className="text-[10px] md:text-sm text-muted-foreground mt-1 font-semibold">
              ⏰ Vagas limitadas • Aproveite enquanto disponível
            </p>
          </div>
          
          <div className="relative max-w-3xl mx-auto mb-3 md:mb-6">
          ...
          <p className="text-sm md:text-base lg:text-lg text-muted-foreground mb-2 md:mb-5 max-w-3xl mx-auto px-2">
          ...
          <div className="mb-3 md:mb-8 max-w-3xl mx-auto">
