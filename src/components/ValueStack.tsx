        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 border-2 border-primary/30 rounded-3xl p-8 md:p-10 text-center">
            ...
            <h3 className="text-2xl md:text-3xl font-black mb-3">
              Acesso online completo por <span className="text-primary">2 anos</span>
            </h3>
            <p className="text-lg md:text-xl text-muted-foreground mb-6">
              <span className="font-bold text-foreground">24 meses de acesso</span> ao curso para você estudar no seu ritmo, rever as aulas quantas vezes precisar
            </p>
