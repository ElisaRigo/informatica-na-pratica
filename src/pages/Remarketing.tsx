      ...
      <div className="relative overflow-hidden bg-slate-900 px-4 py-4 md:py-6">
        ...
        <div className="container relative mx-auto max-w-4xl text-center">
          ...
          <p className="relative text-lg font-black leading-tight text-white md:text-2xl">
            ...
            <span className="block whitespace-nowrap text-[7.1vw] leading-tight md:text-[3.8rem]">Vou te ensinar a usar o</span>
            ...
            <span className="mt-1 block whitespace-nowrap text-[7.6vw] leading-tight md:text-[3.8rem]">de uma vez por todas!</span>
          </p>
