    ...
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-white">
      ...
      <div className="container mx-auto px-4 py-6 md:py-10">
        <div className="max-w-5xl mx-auto text-center">
          <span className="inline-flex items-center justify-center gap-2 bg-blue-100 text-blue-700 text-sm md:text-lg font-bold px-3 py-1.5 rounded-full mb-5 w-full">
            <GraduationCap className="w-5 h-5 md:w-7 md:h-7" /> Curso 100% Online • Aulas Passo a Passo
          </span>
