      ...
      <section className="py-4 md:py-6 bg-slate-100">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="text-center">
            ...
            <h2 className="text-[clamp(0.9rem,4.2vw,2.25rem)] md:text-3xl font-extrabold tracking-tight whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r from-foreground via-primary to-foreground leading-tight">
