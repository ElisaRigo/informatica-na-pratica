    ...
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-white">
      ...
      <div className="container mx-auto px-4 py-6 md:py-10">
        <div className="max-w-5xl mx-auto text-center">
          <span className="inline-flex items-center justify-center gap-2 bg-blue-100 text-blue-700 text-base md:text-xl font-bold px-3 py-1.5 rounded-full mb-5 w-full whitespace-nowrap">
            <GraduationCap className="w-6 h-6 md:w-8 md:h-8" /> Curso 100% Online • Aulas Passo a Passo
          </span>
