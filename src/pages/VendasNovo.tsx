      ...
      <div className="container mx-auto px-4 py-4 md:py-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-base md:text-xl text-slate-700 max-w-3xl mx-auto mb-4">
            Em poucas aulas, você vai conseguir criar documentos e planilhas, organizar arquivos, enviar e-mails e navegar na internet sem depender de ninguém.
          </p>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center space-y-4">
          <p className="text-slate-700 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            Essa é a mesma didática que já fez <strong className="text-slate-900">+15.000 pessoas</strong> saírem do zero e usarem o computador com confiança.
          </p>
...
const StickyMobile = () => (
  <div className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-white border-t border-slate-200 p-3 shadow-2xl">
    <button onClick={openCheckout} className="w-full bg-green-600 active:scale-[.99] text-white font-extrabold text-base py-4 rounded-xl flex items-center justify-center gap-2">
