    ...
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-white">
      <div className="container mx-auto px-4 py-3 md:py-4">
        <div className="max-w-5xl mx-auto text-center">
          <span className="inline-flex items-center justify-center gap-1.5 bg-blue-100 text-blue-700 text-[11px] md:text-sm font-bold px-3 py-1 rounded-full mb-3 whitespace-nowrap border border-blue-200 shadow-sm">
            <GraduationCap className="w-3.5 h-3.5 md:w-4 md:h-4" /> Para quem está começando do zero
          </span>
