...
const CTA = ({ children = "Quero aprender informática agora", size = "lg", subtle = false }: any) => (
  <button
    ...
    className={`group inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 active:scale-[.99] text-white font-extrabold rounded-2xl shadow-lg shadow-green-600/20 transition-all w-full sm:w-auto ${
      size === "lg" ? "text-base md:text-lg px-7 py-4 md:px-10 md:py-5" : "text-sm md:text-base px-6 py-3"
