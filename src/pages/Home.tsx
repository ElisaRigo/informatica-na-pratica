    ...
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-white">
      <div className="container mx-auto px-4 py-2 md:py-3">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-[2.15rem] md:text-6xl lg:text-7xl font-black text-slate-900 leading-[1.05] tracking-[-0.04em] mb-2 mx-0 px-4 md:mx-[-1rem] md:px-4 text-center">
            <span className="block">Domine o computador</span>
            <span className="block text-blue-600">mesmo começando</span>
            <span className="block text-blue-600 underline decoration-green-500 decoration-4 underline-offset-4">do Zero</span>
          </h1>
