          ...
          <div className="relative max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/10 border border-slate-200 mb-5">
            {!isPlaying ? (
              ...
              <div className="aspect-video relative">
                <iframe
                  src="https://www.youtube-nocookie.com/embed/0kFjFZX5c9I?rel=0&modestbranding=1&showinfo=0&controls=1&playsinline=1&iv_load_policy=3&fs=1&cc_load_policy=0&autoplay=1"
                  title="Aula gratuita"
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="relative max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/10 border border-slate-200 mb-6">
          {!isPlaying ? (
            ...
            <div className="aspect-video relative">
              <iframe
                src="https://www.youtube-nocookie.com/embed/_0OPLnEiMHk?rel=0&controls=1&modestbranding=1&showinfo=0&playsinline=1&iv_load_policy=3&fs=1&cc_load_policy=0&autoplay=1"
