...
const ComoComeca = () => (
  <section className="bg-slate-950 py-10 md:py-14 border-b border-slate-800">
    <div className="container mx-auto px-4 max-w-4xl">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        {[
          { n: "1", t: "Você garante sua vaga", d: "Cartão em até 3x ou outra forma local. Leva menos de 3 minutos." },
    ...
    <div className="container mx-auto px-4 max-w-3xl">
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-2xl p-5 md:p-7">
        ...
        <ul className="divide-y divide-slate-800">
          {[
            ["Curso completo com +90 videoaulas", "€ 97"],
            ["Bônus 1 · Atalhos do computador", "€ 19"],
            ["Bônus 2 · Mercado de trabalho", "€ 25"],
            ["Bônus 3 · Currículo campeão", "€ 19"],
            ["Bônus 4 · Suporte com a equipe", "€ 9"],
        ...
        <div className="text-center mt-5 pt-5 border-t border-slate-800">
          ...
          <p className="text-slate-300 text-base mt-3">
            De <span className="line-through font-bold text-xl">€ 97,00</span> por apenas
          </p>
          <p className="text-6xl md:text-7xl font-black text-green-400 leading-none tracking-tight my-1">€ 57</p>
            <p className="text-slate-300 font-semibold">à vista ou em até 3 x 19,00 no cartão</p>
...
const FAQ = () => {
  ...
  const items = [
    ...
    ["Como eu pago?", "Cartão em até 3x ou outras formas locais disponíveis no checkout. O acesso chega no seu e-mail logo após a confirmação."],
...
const CTAFinal = ({ onOpenModal }: { onOpenModal: () => void }) => (
  <section className="bg-gradient-to-b from-blue-700 to-slate-950 py-12 md:py-16">
    <div className="container mx-auto px-4 max-w-2xl text-center">
      ...
      <CTA onClick={onOpenModal} sub="Acesso imediato • Garantia de 7 dias">COMEÇAR AGORA POR € 57</CTA>
    </div>
  </section>
);
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-1.5 mb-3">
          {CHECKOUT_ITEMS.map(({ icon: I, label, sub }) => (
            <div
              key={label}
              className="flex flex-col items-center justify-center text-center gap-1 bg-slate-950 border border-slate-800 rounded-xl px-2 py-2.5"
            >
        ...
        <div className="text-center mb-2">
          <p className="text-slate-300 text-xs md:text-sm">
            De <span className="line-through font-bold text-base">€ 97,00</span> por apenas
          </p>
          <p className="text-3xl md:text-4xl font-black text-green-400 leading-none tracking-tight my-1">€ 57</p>
          <p className="text-slate-300 font-semibold text-[11px] md:text-xs">à vista ou em até 3 x 19,00 no cartão</p>
        </div>
        ...
        <div className="bg-slate-950/50 border border-slate-700/50 rounded-xl p-3 mb-3 text-center">
          <p className="text-slate-300 text-sm md:text-base leading-snug flex flex-col items-center justify-center gap-0.5">
            <span className="flex items-center justify-center gap-1.5">
              <Lock className="w-4 h-4 text-blue-400 shrink-0" />
              Pagamento processado com segurança
            </span>
            <span>pela plataforma <span className="text-white font-bold text-base md:text-lg">Hotmart</span></span>
          </p>
        </div>
  ...
  <div className="fixed bottom-0 left-0 right-0 z-40 bg-slate-950/95 backdrop-blur border-t border-slate-800 p-3 md:p-4 transition-transform duration-300 translate-y-0">
    <div className="max-w-4xl mx-auto flex items-center justify-between gap-3">
      <div className="hidden md:block text-left">
        ...
        <p className="text-slate-300 text-xs">Acesso vitalício por € 57</p>
      </div>
      <button
        onClick={onOpenModal}
...
const Portugal = () => {
  ...
  useEffect(() => {
    document.title = "Curso de Informática do Zero — Para Portugal";
