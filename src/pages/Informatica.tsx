    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          {/* CTA Button - acima do preço */}
          <div className="flex justify-center mb-3">
            <button
              onClick={() => (window as any).openCheckout?.()}
              className="w-full max-w-lg inline-flex items-center justify-center gap-2 bg-success hover:bg-success/90 text-white font-black text-lg md:text-xl px-10 py-4 md:py-5 rounded-full shadow-2xl shadow-success/30 hover:shadow-success/50 hover:scale-[1.02] transition-all duration-300"
            >
              🎯 QUERO COMEÇAR AGORA!
            </button>
          </div>
          ...
          <div className="bg-background rounded-2xl p-4 md:p-6 max-w-lg mx-auto text-center">
            <p className="text-base md:text-lg text-muted-foreground mb-0.5">
              De{" "}
